...
@CSFSliderQueryRegistry.register_tag_handler(filter_type=CSFSliderTagType.GENDER)
class CSFGenderTagHandler(CSFSliderTagHandler):
    """ Tags. """

    # noinspection PyMissingOrEmptyDocstring
    def get_tags(self, slider: CSFSlider) -> Tuple[Any]:
        return tuple(slider.available_for.genders)

    # noinspection PyMissingOrEmptyDocstring
    def applies(self, slider: CSFSlider) -> bool:
        return len(slider.available_for.genders) > 0
