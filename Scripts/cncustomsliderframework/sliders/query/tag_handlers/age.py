...
@CSFSliderQueryRegistry.register_tag_handler(filter_type=CSFSliderTagType.AGE)
class CSFAgeTagHandler(CSFSliderTagHandler):
    """ Tags. """

    # noinspection PyMissingOrEmptyDocstring
    def get_tags(self, slider: CSFSlider) -> Tuple[Any]:
        return tuple(slider.available_for.ages)

    # noinspection PyMissingOrEmptyDocstring
    def applies(self, slider: CSFSlider) -> bool:
        return len(slider.available_for.ages) > 0
